...
public class MainActivity extends AppCompatActivity {
    ...
    private void Jatek(String userPick1) {
        ...
        if (gepPick.equals(userPick)) {
            ...
            textViewOutt.setText(String.format("Döntetlenek száma: %d", Dontetlenek));
            kepSet();
            ...
            UserPoints++;
            Toast.makeText(MainActivity.this, "Az erő veled van.", Toast.LENGTH_SHORT).show();
            textViewOut.setText(String.format("Eredmény: Ember: %d Computer: %d", UserPoints, GepPoints));
            kepSet();
        } else {
            GepPoints++;
            Toast.makeText(MainActivity.this, "A CPU sötét oldala erősebb mint azt hittük.", Toast.LENGTH_SHORT).show();
            textViewOut.setText(String.format("Eredmény: Ember: %d Computer: %d", UserPoints, GepPoints));
            kepSet();
        }
        if (GepPoints == 3) {
    ...
    private void init() {
        ...
        textViewOutt = findViewById(R.id.textviewOutt);
